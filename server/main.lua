...
function CheckFrameworkVersion()
    PerformHttpRequest("https://raw.githubusercontent.com/HariboInc/esx_mdt/main/version.txt", function(err, text, headers)
        if string.match(text, version) then
            ...
            print("^4https://github.com/HariboInc/esx_mdt^7")
            print("--------------------------------------------")
            print(" ")
        else
          print(" ")
